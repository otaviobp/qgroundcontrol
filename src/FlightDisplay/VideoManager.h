...
public:
    ...
    Q_PROPERTY(bool             isAvahiStream READ    isAvahiStream                         NOTIFY videoSourceChanged)
    ...
    Q_PROPERTY(AvahiVideoManager* avahiVideoManager READ  avahiVideoManager               CONSTANT)
    ...
    AvahiVideoManager* avahiVideoManager () { return &_avahiVideoManager; }
...
private:
    ...
    QString             _rtspURL;
    bool                _init;
    AvahiVideoManager _avahiVideoManager;
};
